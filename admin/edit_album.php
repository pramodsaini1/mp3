            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
					  ...
					  <div class="col-sm-6">
                        <img src="../album/<?php echo $r["code"]?>.jpg" class="img-fluid">					  
					  
					  </div>
					  <div class="col-sm-6">
						 
						<form method="post"  action="update_album.php?code=<?php echo $code?>">
						<label>Edit-album:</label>
 						<input type="text" name="album_name" class="form-control" value="<?php echo $r["album_name"]?>"><br><br>
 						 <textarea class="form-control" name="description"><?php echo $r["description"]?></textarea><br>
 						  <input type="submit" value="submit" class="btn btn-warning" >
                          </form>
						  <form  enctype="multipart/form-data" action="photo_update.php?code=<?php echo $code?>">
